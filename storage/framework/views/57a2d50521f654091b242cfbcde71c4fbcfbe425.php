        ...
        <div class="container divLogo">
            <div class="row">
                <div class="col-sm-12" style="padding-left: 0 !important">
                    <img src="<?php echo e(asset('asset/t_logo.jpg')); ?>" alt="companyLogo" class="imgLogo col-sm-2 float-left"/>
                </div>
            </div>
        </div>
    </div>
...
<div class="text-center">
    ...
    <a class="btn float-left btn-success startBtn" href="<?php echo e(url('/search/information')); ?>">
        Start
    </a>
</div>
    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-3 footerProvider">
                        <h2>Powered by</h2>
                        <img class="b_logo" src="<?php echo e(asset('asset/b_logo.png')); ?>" alt="powerLogo"/></div>
                </div>
            </div>
        </div>
    </footer>
